            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder text-capitalize">Modef</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Selamat Datang di Modef! 👋</h4>
              <p class="mb-4">Sistem penilaian portfolio tata busana SMKN 8 Surabaya.</p>
