            ...
            <div class="authentication-inner py-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mb-4">Masukkan Password Baru</h4>
                        <form class="mb-3" action="{{ route('validation-forgot-password-act') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="konfirmasiPasswordBaru" class="form-control" name="konfirmasiPasswordBaru"
                                        placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                        aria-describedby="password" required />
                                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                                </div>
